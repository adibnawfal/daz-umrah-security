<div id="hs-delete-staff-{{ $staffData->id }}-modal"
  ...
  <div
    ...
    <div
      ...
      <form method="post" action="{{ route('profile.delete-staff', $staffData->id) }}">
        @csrf
        @method('delete')

        <div class="flex items-center justify-between px-4 py-3 border-b dark:border-gray-700">
          <h3 class="font-bold text-gray-800 dark:text-white">
            Delete Staff {{ $staffData->first_name }} {{ $staffData->last_name }}
          </h3>
          <button type="button"
