          ...
          <div class="flex flex-col p-4 bg-white shadow-lg sm:p-7 rounded-2xl dark:bg-slate-900">
            ...
            <div class="mt-5">
              ...
              <form method="post" action="{{ route('verification.send') }}">
                ...
                <div class="grid mb-2 gap-y-4">
                  <button type="submit"
                    class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-white bg-[#c31e39] border border-transparent rounded-lg gap-x-2 hover:bg-[#9c182e] disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
              ...
              <form method="post" action="{{ route('logout') }}">
                ...
                <div class="grid gap-y-4">
                  <button type="submit"
                    class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-[#c31e39] border-[#c31e39] border-2 rounded-lg gap-x-2 hover:bg-[#c31e39] hover:text-white disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                    Log Out
                  </button>
                </div>
              </form>
